...
function report_discussion_metrics_getdiscussionmodcontextidlookup($courseid) {
    global $DB;
    $forumlookup = [];
...
function report_discussion_metrics_countattachmentmultimedia($modcontextid, $postid) {
    $count = new stdClass();
    $count->num = 0;
    $count->img = 0;
    $count->video = 0;
